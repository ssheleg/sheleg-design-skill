...
| P-17 | `v1.30.0` tagged, released, published; every local channel serves it | `gh run view`, `npm view`, the resolved install paths | **never** — the change is authored, merged and gated, not released. `npm` still serves 1.29.0 | **never** |
