...
| REQ-010 | A behavioral scenario **`T13`** in `test/scenarios.md` covering design-sync discovery and the four reference-type rules | scenario run by a fresh subagent; verdict recorded at stage 10 | open |
