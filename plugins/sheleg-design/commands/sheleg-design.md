...
- **If the arguments name a style pack, use that pack without re-asking.** The
  thirty-four packs are `instrument-console`, `editorial-luxury`, `workbench`,
  `briefing-room`, `atrium`, `babylove`, `patchbay`, `nameplate`, `rimlight`, `outrank`, `orchard`, `field-notes`, `cyclorama`, `showroom`,
