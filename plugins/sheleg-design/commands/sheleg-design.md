...
- **If the arguments name a style pack, use that pack without re-asking.** The
  thirty-five packs are `instrument-console`, `editorial-luxury`, `workbench`,
  `briefing-room`, `atrium`, `babylove`, `patchbay`, `nameplate`, `rimlight`, `onionskin`, `outrank`, `orchard`, `field-notes`, `cyclorama`, `showroom`,
